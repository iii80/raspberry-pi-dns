...
大家好，我是卡卡，深圳 3 流程序员一枚。本教程的实验环境为树莓派，理论上只要是 Linux 系统就可以，可能细节步骤有所差别。教程仅限于交流学习，禁止用于非法用途。
...
经过上面的步骤，我们应该可以上 Google 了，这里说一些小技巧，我们可以在上面的 ipset 中设置一个广告集合，将广告的网址我们转发到一个不能解析的端口，这样就可以实现屏蔽广告。