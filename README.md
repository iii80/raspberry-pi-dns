...
大家好，我是卡卡。由于家里的网络总是被运营商进行 DNS 污染，本来能访问的域名总是被屏蔽掉，于是萌生了利用树莓派做个 DNS 解析的想法，中途又把代理程序在树莓派上跑起来，实现自动代理。配置过程中也走了很多弯路，网上教程没有找到一个比较系统的配置方法，于是把自己的经验与大家分享一下，希望能对大家有所帮助。本教程的实验环境为树莓派，理论上只要是 Linux 系统就可以，可能细节步骤有所差别。教程仅限于交流学习，禁止用于非法用途。
